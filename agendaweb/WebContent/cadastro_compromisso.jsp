				      					...
				      					<ul id="lista_erros"></ul>
											...
											<div class="form-row  mt-2">
												<div class="form_group col-md-12">
													...
													<input id="descricao" class="form-control" type="text" name="txt_descricao">
												</div>
											</div>
											<div class="form-row  mt-2">
												<div class="form_group col-md-3">
													<label for="data">Data:</label>
													<input id="data" class="form-control" type="date" name="txt_data">
												</div>
												<div class="form_group col-md-3">
													<label for="horario">Horário:</label>
													<input id="horario" class="form-control" type="time" name="txt_horario">
												</div>
												<div class="form_group col-md-6">
													<label for="local">Local:</label>
													<input id="local" class="form-control" type="text" name="txt_local">
												</div>
											</div>
											<div class="form-row mt-2">
												<div class="form_group col-md-12">
													<label for="observacao">Observação:</label>
													<textarea id="observacao" class="form-control" name="txt_observacao"></textarea>
												</div>
											</div>
											<div class="form-row mt-2">
												<div class="form_group col-md-4">
													<input id="concluido" value="true" type="checkbox" name="concluido">
											...
											<div class="form-row">
												<div class="form_group col-md-12 text-right mt-3">
													...
													<button id="bt_compromisso" class="btn btn-success" type="submit">Salvar</button>
												</div>
											</div>
										</form>
									</div>
