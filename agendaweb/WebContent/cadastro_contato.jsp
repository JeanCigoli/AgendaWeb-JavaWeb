				      					...
				      					<ul id="lista_erros"></ul>
											...
											<div class="form-row  mt-2">
												<div class="form_group col-md-8">
													...
													<input id="nome" class="form-control" type="text" name="txt_nome">
												</div>
												<div class="form_group col-md-4">
													<label for="dataNascimento">Data Nasc.:</label>
													<input id="dataNascimento" class="form-control" type="date" name="txt_datanascimento">
												</div>
											</div>
											<div class="form-row  mt-2">
												<div class="form_group col-md-6">
													<label for="email">E-mail:</label>
													<input id="email" class="form-control" type="email" name="txt_email">
												</div>
												<div class="form_group col-md-3">
													<label for="telefone">Telefone:</label>
													<input id="telefone" class="form-control" type="text" name="txt_telefone">
												</div>
												<div class="form_group col-md-3">
													...
													<select id="tipo_combo" name="combo_tipo" class="form-control">
														...
														<option value="<%= Tipo.AMIGO %>">AMIGO</option>
														<option value="<%= Tipo.FAMILIA %>">FAMILIA</option>
														<option value="<%= Tipo.PROFISSIONAL %>">PROFISSIONAL</option>
													</select>
												</div>
											</div>
											<div class="form-row mt-2">
												<div class="form_group col-md-12">
													...
													<input id="endereco" class="form-control" type="text" name="txt_endereco">
												</div>
											</div>
											<div class="form-row">
												<div class="form_group col-md-12 text-right mt-3">
													<a class="btn btn-danger" href="meus_contatos.jsp">Cancelar</a>
													<button id="bt_cadastro_contato" class="btn btn-success" type="submit">Salvar</button>
												</div>
											</div>
										</form>
									</div>
