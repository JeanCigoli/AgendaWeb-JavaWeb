								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="alert alert-danger">
											<h5>Excluir Compromisso</h5>
										</div>
										<form id="formulario_cadastro" action="ExcluirCompromissoServlet" method="post">
											<div id="alerta_erro">
				      					<ul id="lista_erros"></ul>
											...
											<div class="form-row">
												<div class="form_group col-md-12 text-right mt-3">
													...
													<button id="bt_compromisso" class="btn btn-danger" type="submit">Excluir</button>
												</div>
											</div>
										</form>
									</div>
