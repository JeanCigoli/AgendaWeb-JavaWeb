							...
							<div class="col-md-9">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<form id="formulario_cadastro" action="ExcluirContatoServlet" method="post">
											<div id="alerta_erro">
				      					<ul id="lista_erros"></ul>
											...
											<div class="form-row">
												<div class="form_group col-md-12 text-right mt-3">
													<a class="btn btn-warning" href="meus_contatos.jsp">Cancelar</a>
													<button id="bt_cadastro_contato" class="btn btn-danger" type="submit">Excluir</button>
												</div>
											</div>
										</form>
									</div>
