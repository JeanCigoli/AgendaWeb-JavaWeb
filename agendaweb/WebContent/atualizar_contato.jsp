							...
							<div class="col-md-9">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<form id="formulario_cadastro" action="AtualizarContatoServlet" method="post">
											<div id="alerta_erro">
				      					<ul id="lista_erros"></ul>
				      				</div>
											<div class="form-row  mt-2">
												<div class="form_group col-md-8">
													<input type="hidden" name="txt_id" value="<%= contato.getId()%>">
											...
											<div class="form-row">
												<div class="form_group col-md-12 text-right mt-3">
													...
													<button id="bt_cadastro_contato" class="btn btn-success" type="submit">Atualizar</button>
												</div>
											</div>
										</form>
									</div>
